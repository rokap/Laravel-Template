...
<!-- #Main ============================ -->
    <div class="page-container">
                    ...
                    <li class="dropdown">
                        <a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
                            <div class="peer mR-10">
                                <img class="w-2r bdrs-50p" src="//randomuser.me/api/portraits/men/1.jpg" alt="">
                            </div>
                            <div class="peer">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0" style="border-radius: 0">
                    ...
                    @foreach(Request::segments() as $segment)
                        <li class="breadcrumb-item" aria-current="page">{{$segment}}</li>
                    @endforeach
                </ol>
            </nav>
        </div>
        ...
        <footer class="bdT ta-c p-30 lh-0 fsz-sm c-grey-600">
            <span>Copyright © Rokap Inc 2019. All rights reserved.</span>
        </footer>
    </div>
</div>
