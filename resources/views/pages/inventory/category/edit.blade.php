...
@section('content')
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('inventory.categories.update',$item)}}" method="post">
                                    ...
                                    <div class="form-check form-group">
                                        <label class="form-check-label">
                                            <input name="purchase" id="can_purchase" type="checkbox" class="form-check-input"
                                                   value="purchase" {{($item->purchase)?'checked':null}} {{($item->asset_account_id != null)?'disabled readonly':null}}>I Purchase this Item
                                        </label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-check form-group">
                                        <label class="form-check-label">
                                            <input name="taxable" id="taxable" type="checkbox" class="form-check-input" value="taxable" {{($item->taxable)?'checked':null}}>Is this item Taxable?
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <div class="form-group">
                                ...
                                <input name="unit_price" type="text" class="form-control" id="unit_price" value="{{old('unit_price',$item->unit_price)}}" placeholder="Unit Price ( 0.00 )">
                        ...
                        <div id="inventory" class="col-md d-none">
                            ...
                            <div class="form-group">
                                ...
                                <input name="qty_on_hand" type="text" class="form-control" id="qty_on_hand" value="{{old('qty_on_hand',(int)$item->qty_on_hand)}}" placeholder="Available Qty" disabled readonly>

                            </div>
                            <div class="form-group">
                                <label>Inventory Start Date</label>
                                <input name="inventory_start_date" type="text" class="form-control" id="inventory_start_date" value="{{old('inventory_start_date',$item->inventory_start_date)}}"  disabled readonly
                    ...
                    <div class="form-group text-right mb-0">
                        ...
                        <!-- Example split danger button -->
                            <button type="submit" name="save" value="close" class="btn btn-success">Save & Close</button>
                    </div>
